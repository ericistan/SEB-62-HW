...
def convert_temperature(temperature, unit):
    return temperature * 9/5 + 32 if unit == 'C' else ((temperature -32) * 5/9 if unit == 'F' else 'unit is invalid')

print('Exercise 4: Convert 0°C to Fahrenheit:', convert_temperature(0, 'C'))
print('Exercise 4: Convert 32°F to Celsius:', convert_temperature(32, 'F'))
print('Exercise 4: Convert 32°Z to Celsius:', convert_temperature(32, 'Z'))
...
def basic_calculator(arg1=0, arg2=0, arg3=""):
    return arg1+arg2 if arg3 == 'add' else (arg1-arg2 if arg3 == 'subtract' else (arg1*arg2 if arg3 == 'multiply' else (arg1/arg2 if arg3 == 'divide' else 'invalid operator')))
...
print('Exercise 9 Result:', basic_calculator(10, 5, "haha"))