...
print('Exercise 1:', calculate_area_triangle(15, 5))
...
def convert_temperature( num, temp_type):
    if temp_type == 'C':
        return (num*9/5)+32
    elif temp_type =='F':
        return (num -32) *5/9
...
#
# Define the function and then call it below.
def basic_calculator(num_1, num_2, operation):
    if operation == 'add':
         return num_1 + num_2
