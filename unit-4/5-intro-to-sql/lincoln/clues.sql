...
-- Write SQL query here
SELECT countries.code, countries.name, countrylanguages.language from countries
...
-- Write SQL query here
SELECT countries.code, countries.name, countrylanguages.language, countrylanguages.isOfficial, countrylanguages.percentage 
From countries
JOIN countrylanguages ON countrylanguages.countrycode=countries.code
...
-- Write SQL query here
SELECT cities.name, countries.name, countries.continent
FROM cities
...
-- Write SQL query here
SELECT countries.capital, cities.name
FROM cities
